...
public class UIManager : MonoBehaviour
{
    ...
    private void RefreshHUD()
    {
        ...
        inGameUI.lifeText.text = $"{GameData.Instance.playerLife}";
        inGameUI.goldText.text = $"{GameData.money}";
    }
    ...
    public void TriggerGameOver()
    {
        ...
        if (GameData.Instance != null)
        {
            gameOverUI.roundText.text = $"{GameData.Instance.survivedRounds} ROUNDS SURVIVED";
        }
